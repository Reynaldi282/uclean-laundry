        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{url('home')}}">
                        ...
                        <h3 class="brand-text">OmahKu<br/>Laundry</h3>
                    </a></li>
...
<!-- 
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">&copy; <?php echo date("Y") ?>  Created by PT. Trisuku Inti Griya Abadi,</a>All rights Reserved</span>
