        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="pull-left m-t-10">
                    <h6 style="font-weight:bold">Dengan Menandatangani/Menerima Nota Ini, Berarti Anda Setuju :</h6>
                    <p>
                        1. Pengambilan barang hanya bisa dilakukan apabila disertai nota<br/>
                        2. Barang yang tidak diambil selama 1 bulan, hilang / rusak tidak diganti<br/>
                        3. Barang hilang/rusak karena proses pengerjaan diganti maksimal 5x biaya.<br/>
                        4. Klaim luntur tidak dipisah diluar tanggungan<br/>
                        5. Hak klaim berlaku 2 jam setelah barang diambil<br/>
                    </p>
                </div>
